            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="border-b border-gray-200 dark:border-gray-700">
                  <tr>
                    <th className="px-6 py-3 text-left font-bold text-gray-900 dark:text-white">Bill #</th>
                    ...
                    <th className="px-6 py-3 text-right font-bold text-gray-900 dark:text-white">Amount</th>
                    <th className="px-6 py-3 text-left font-bold text-gray-900 dark:text-white">Type</th>
