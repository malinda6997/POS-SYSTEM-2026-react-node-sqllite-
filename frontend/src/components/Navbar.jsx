...
const Navbar = ({ onMenuClick }) => {
  ...
  return (
    <nav className="sticky top-0 bg-white dark:bg-slate-950 border-b border-gray-200 dark:border-slate-800 px-6 py-4 flex items-center justify-between z-30 shadow-sm">
      <div className="flex items-center gap-4 flex-1">
        <button
          onClick={onMenuClick}
          className="p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition md:hidden"
        >
      ...
      <div className="flex items-center gap-6 ml-auto">
        {/* Search */}
        <div className="hidden lg:flex items-center bg-gray-100 dark:bg-slate-800 rounded-lg px-4 py-2.5 max-w-xs">
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-48 border border-gray-200 dark:border-slate-800 rounded-lg py-2 z-50">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition text-sm"
              >
